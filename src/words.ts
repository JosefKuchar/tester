...
export let words = [
  ...
  },
  {
    name: "U1",
    words: [
      { en: ['beard'], cs: ['vousy', 'bradka'] },
      { en: ['black'], cs: ['černý'] },
      { en: ['board game'], cs: ['desková hra'] },
      { en: ['bowling'], cs: ['bowling'] },
      { en: ['brown'], cs: ['hnědý'] },
      { en: ['canteen'], cs: ['jídelna'] },
      { en: ['chemistry'], cs: ['chemie'] },
      { en: ['chess'], cs: ['šachy'] },
      { en: ['classroom'], cs: ['třída'] },
      { en: ['coat'], cs: ['kabát'] },
      { en: ['corridor'], cs: ['chodba'] },
      { en: ['curly'], cs: ['kudrnatý'] },
      { en: ['dance'], cs: ['tanec'] },
      { en: ['dark'], cs: ['tmavý'] },
      { en: ['desk'], cs: ['školní lavice'] },
      { en: ['drama'], cs: ['divadlo', 'dramatická výchova'] },
      { en: ['drawing'], cs: ['kreslení'] },
      { en: ['fair'], cs: ['světlý'] },
      { en: ['geography'], cs: ['zeměpis'] },
      { en: ['gym'], cs: ['tělocvična'] },
      { en: ['hair'], cs: ['vlasy'] },
      { en: ['hall'], cs: ['hala', 'předsíň'] },
      { en: ['hat'], cs: ['klobouk'] },
      { en: ['homework'], cs: ['domácí úkol'] },
      { en: ['ice skating'], cs: ['bruslení na ledě'] },
      { en: ['interactive whiteboard'], cs: ['interaktivní tabule'] },
      { en: ['IT'], cs: ['informatika'] },
      { en: ['jacket'], cs: ['bunda'] },
      { en: ['jumper'], cs: ['svetr'] },
      { en: ['laptop'], cs: ['notebook'] },
      { en: ['leggings'], cs: ['legíny'] },
      { en: ['long'], cs: ['dlouhý'] },
      { en: ['moustache'], cs: ['knír'] },
      { en: ['music'], cs: ['hudba'] },
      { en: ['noticeboard'], cs: ['nástěnka'] },
      { en: ['PE'], cs: ['tělocvik'] },
      { en: ['picnic'], cs: ['piknik'] },
      { en: ['playing field'], cs: ['hřiště'] },
      { en: ['reception'], cs: ['recepce'] },
      { en: ['red'], cs: ['červený'] },
      { en: ['shirt'], cs: ['košile'] },
      { en: ['short'], cs: ['krátký'] },
      { en: ['skateboarding'], cs: ['jízda na skateboardu'] },
      { en: ['staff room'], cs: ['sborovna'] },
      { en: ['straight'], cs: ['rovný'] },
      { en: ['sweatshirt'], cs: ['mikina'] },
      { en: ['textbook'], cs: ['učebnice'] },
      { en: ['tie'], cs: ['kravata'] },
      { en: ['trousers'], cs: ['kalhoty'] },
      { en: ['video games'], cs: ['video hry'] },
      { en: ['walk'], cs: ['procházka'] },
      { en: ['wavy'], cs: ['vlnitý'] },
      { en: ['whiteboard'], cs: ['bílá tabule'] },
      { en: ['a bit'], cs: ['trochu'] },
      { en: ['a little bit'], cs: ['trošku'] },
      { en: ['annoyed'], cs: ['rozladěný', 'otravný'] },
      { en: ['annoying'], cs: ['otravný', 'protivný'] },
      { en: ['anxious'], cs: ['nervózní', 'znepokojený'] },
      { en: ['ashamed'], cs: ['zahanbený'] },
      { en: ['ask for'], cs: ['žádat o'] },
      { en: ['bleed'], cs: ['krvácet'] },
      { en: ['blood'], cs: ['krev'] },
      { en: ['bored'], cs: ['znuděný'] },
      { en: ['boring'], cs: ['nudný'] },
      { en: ['break your arm'], cs: ['zlomit si paži'] },
      { en: ['broken arm'], cs: ['zlomená paže'] },
      { en: ['bruise'], cs: ['modřina', 'podlitina', 'potlouct se'] },
      { en: ['burn'], cs: ['spálit se', 'popálit se'] },
      { en: ['confused'], cs: ['zmatený'] },
      { en: ['confusing'], cs: ['matoucí'] },
      { en: ['cross'], cs: ['naštvaný', 'mrzutý', 'podrážděný'] },
      { en: ['cut'], cs: ['řezná rána', 'říznout se'] },
      { en: ['delighted'], cs: ['nadšený', 'potěšený'] },
      { en: ['disappointed'], cs: ['zklamaný'] },
      { en: ['disgusted'], cs: ['znechucený'] },
      { en: ['disgusting'], cs: ['nechutný'] },
      { en: ['embarrassed'], cs: ['v rozpacích', 'rozpačitý'] },
      { en: ['embarrassing'], cs: ['trapný'] },
      { en: ['envious'], cs: ['závistivý'] },
      { en: ['excited'], cs: ['vzrušený'] },
      { en: ['exhausted'], cs: ['vyčerpaný'] },
      { en: ['exhausting'], cs: ['vyčerpávající'] },
      { en: ['extremely'], cs: ['nesmírně'] },
      { en: ['fall over'], cs: ['upadnout'] },
      { en: ['find out'], cs: ['zjistit'] },
      { en: ['frightened'], cs: ['vystrašený'] },
      { en: ['frightening'], cs: ['strašidelný'] },
      { en: ['get over'], cs: ['dostat se z', 'překonat'] },
      { en: ['hurt'], cs: ['bolet', 'zranit'] },
      { en: ['injure yourself'], cs: ['poranit se'] },
      { en: ['injury'], cs: ['zranění'] },
      { en: ['interested'], cs: ['zaujatý', 'mající zájem'] },
      { en: ['interesting'], cs: ['zajímavý'] },
      { en: ['look at'], cs: ['podívat se na'] },
      { en: ['own up'], cs: ['přiznat se', 'kápnout božskou'] },
      { en: ['pain'], cs: ['bolest'] },
      { en: ['proud'], cs: ['pyšný'] },
      { en: ['put back'], cs: ['vrátit se na své místo'] },
      { en: ['rather'], cs: ['docela'] },
      { en: ['relieved'], cs: ['uvolněný', 'zbavený napětí'] },
      { en: ['satisfied'], cs: ['spokojený'] },
      { en: ['satisfying'], cs: ['uspokojivý'] },
      { en: ['shocked'], cs: ['šokovaný'] },
      { en: ['shocking'], cs: ['šokující'] },
      { en: ['slip over'], cs: ['uklouznout'] },
      { en: ['sprain'], cs: ['výron', 'vyvrtnout si'] },
      { en: ['surprised'], cs: ['překvapený'] },
      { en: ['surprising'], cs: ['překvapivý'] },
      { en: ['suspicious'], cs: ['podezíravý'] },
      { en: ['talk about'], cs: ['mluvit o'] },
      { en: ['tired'], cs: ['unavený'] },
      { en: ['tiring'], cs: ['únavný'] },
      { en: ['trip over'], cs: ['zakopnout'] },
      { en: ['upset'], cs: ['naštvaný', 'rozzlobený'] },
      { en: ['very'], cs: ['velmi'] },
      { en: ['worried'], cs: ['ustaraný', 'mající obavy'] },
      { en: ['worrying'], cs: ['znepokojivý'] },
    ]
  }
];
